...
/**
 * Created by Snow Volf on 02.08.2017, 15:55
 */

public class InteractionSettingsFragment extends PreferenceFragment {
    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.preferences_interaction);
        findPreference(Constants.prefs.PERFORMANCE_RETURN).setOnPreferenceClickListener(__ -> {
    ...
    public void onResume() {
        super.onResume();
        getActivity().setTitle(R.string.pref_ctg_performance);
    }
}
