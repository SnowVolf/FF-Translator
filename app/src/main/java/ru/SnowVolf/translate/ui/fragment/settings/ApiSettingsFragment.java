...
public class ApiSettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    @Override
    ...
    public void onResume() {
        super.onResume();
        getActivity().setTitle(R.string.pref_ctg_api);
    }
